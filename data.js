...
const freshwaterData = {
    ...
    "hydro-8": {
        ...
        criteria: [
            { icon: "💧", label: "유형", text: "담수호 / 염호" },
            { icon: "📉", label: "이슈", text: "수위 저하 / 오염" },
            { icon: "🏞️", label: "형성", text: "빙하, 단층, 화산" }
        ],
        subCards: [
            {
                title: "담수호", desc: "문명을 키우고 생태계를 지탱하는 눈에 보이는 물.",
                items: [
                    { name: "북미 오대호", examples: ["나이아가라 폭포", "시카고", "디트로이트", "토론토"], meta: "🗺️ 244,100km² · 💧 세계 담수의 21%", desc: "빙하가 파놓은 북미 대륙의 거대한 담수 시스템이자 내륙의 바다" },
                    { name: "아프리카 대호수", examples: ["빅토리아호", "탕가니카호", "말라위호", "지구대"], meta: "🌍 인류의 요람 · 🐟 고유종(시클리드)", desc: "동아프리카 지구대가 갈라지며 형성된, 인류 진화의 무대이자 생물 다양성의 보고." },
            ...
            {
                title: "염호와 내해", desc: "바다로 흐르지 못하고 고립된 물",
                items: [
        ...
        subCards: [
            ...
            },
            {
                ...
                items: [
                    ...
                    { name: "순다 해협", examples: ["자바섬", "수마트라섬", "크라카타우 화산"], meta: "↔️ 말라카 대체 항로 · 🌋 화산 활동", desc: "말라카 해협의 대체 항로이자, 크라카타우 화산으로 유명한 지정학적 요충지." },
                    { name: "모잠비크 해협", examples: ["마다가스카르", "동아프리카", "천연가스전"], meta: "↔️ 세계 최장 해협 · 🛢️ 수에즈 우회로", desc: "수에즈 운하를 통과한 유조선의 주요 항로이자, 신흥 에너지 허브." },
                    { name: "외레순 해협", examples: ["코펜하겐", "말뫼", "외레순 대교"], meta: "↔️ 발트해 관문 · 💰 통행세 역사", desc: "과거 덴마크의 부를 책임졌던 발트해의 관문. 현재는 초국경 경제권의 중심." }
                ]
            },
            {
                ...
                items: [
                    ...
                    { name: "바브엘만데브 해협", examples: ["예멘", "지부티", "홍해 입구", "후티 반군"], meta: "🌊 홍해의 입구 · 💥 지정학적 핫스팟", desc: "수에즈 운하로 가는 관문. 내전과 해적, 반군의 위협으로 긴장이 고조되는 곳." },
                    { name: "대만 해협", examples: ["타이완", "중국 본토", "미중 갈등"], meta: "↔️ 폭 130km · ⚔️ 양안 대치", desc: "중국의 대양 진출 길목이자, 미중 패권 경쟁의 최전선에 놓인 화약고." },
                    { name: "덴마크 해협", examples: ["그린란드", "아이슬란드", "GIUK 갭"], meta: "🛡️ 대서양 방어선 · 🇷🇺 러시아 함대", desc: "냉전 시대부터 러시아 잠수함의 대서양 진출을 막는 NATO의 핵심 방어선." }
                ]
            },
            {
                ...
                items: [
                    ...
                    { name: "마젤란 해협", examples: ["푼타아레나스", "티에라델푸에고", "파나마 운하 이전"], meta: "↔️ 파나마 대체 항로 · 🗺️ 세계 일주", desc: "파나마 운하 개통 전, 대서양과 태평양을 잇던 유일한 항로이자 마젤란의 흔적." },
                    { name: "토레스 해협", examples: ["호주 북부", "뉴기니섬", "산호초"], meta: "↔️ 얕은 수심 · 👣 인류 이동 경로", desc: "빙하기 인류 이동의 통로였으며, 얕은 수심과 산호초로 항해가 위험한 해협." }
                ]
            }
        ]
    },
        ...
        subCards: [
            {
                ...
                items: [
                    ...
                    { name: "에게해", examples: ["크레타", "산토리니", "미노아/미케네 문명"], meta: "🏛️ 고대 그리스 문명 · 🏝️ 다도해", desc: "수천 개의 섬 위에서 고대 그리스 문명이 꽃피운, 서양 문명의 또 다른 요람." }
                ]
            },
            {
                ...
                items: [
                    ...
                    { name: "동중국해", examples: ["센카쿠/댜오위다오", "이어도", "대륙붕 가스전"], meta: "⚔️ 한중일 각축장 · 🛢️ 해저 자원", desc: "한중일 3국의 EEZ가 중첩되고 해저 자원을 둘러싼 갈등이 끊이지 않는 바다." },
                    { name: "카스피해", examples: ["바쿠", "악타우", "법적 지위 논쟁"], meta: "🌊 바다인가 호수인가 · 🛢️ 에너지 보고", desc: "법적 지위에 따라 해저 자원 분할 방식이 달라지는, 연안국들의 첨예한 이해관계가 얽힌 곳." }
                ]
            },
            {
                ...
                items: [
                    ...
                    { name: "기니만", examples: ["라고스", "아비장", "해상 유전", "노예 해안"], meta: "🛢️ 아프리카 최대 유전 · ⛓️ 노예 무역의 상흔", desc: "아프리카 최대 산유국들이 밀집해 있으며, 노예 무역의 비극적 역사가 서린 바다." }
                ]
            }
        ]
    },
        ...
        subCards: [
            ...
            },
            {
                ...
                items: [
                    ...
                    { name: "동오스트레일리아 해류", examples: ["그레이트 배리어 리프", "시드니", "산호초"], meta: "🇦🇺 호주의 난류 · 🐠 열대 생태계", desc: "호주 동부 해안을 따라 흐르며 그레이트 배리어 리프의 산호초 생태계를 지탱." }
                ]
            },
            {
                title: "기후를 만드는 한류", desc: "고위도의 찬물을 저위도로 운반하는 차가운 바닷물",
                items: [
                    { name: "페루(훔볼트) 해류", examples: ["아타카마 사막", "용승 어장", "안초비"], meta: "🏜️ 해안 사막 형성 · 🐟 세계 3대 어장", desc: "강력한 용승으로 세계적인 어장을 만들고, 대기를 냉각시켜 가장 건조한 사막을 형성." },
                    { name: "캘리포니아 해류", examples: ["캘리포니아 해안", "여름 안개", "지중해성 기후"], meta: "🌫️ 서늘한 여름 · 🍇 와인 산지", desc: "북미 서해안에 서늘하고 건조한 여름을 가져와 지중해성 기후를 만드는 해류." },
                    { name: "벵겔라 해류", examples: ["나미브 사막", "해안 안개", "다이아몬드 해안"], meta: "💎 아프리카의 한류 · 🏜️ 안개 사막", desc: "아프리카 남서 해안에 나미브 사막을 형성하고 안개를 발생시키는 한류." },
                    { name: "카나리아 해류", examples: ["북아프리카 서안", "사하라 사막", "대항해시대"], meta: "⛵️ 귀환 항로 · 🏜️ 사막 확장", desc: "사하라 사막의 건조 기후에 영향을 주며, 과거 범선 시대의 귀환 항로로 이용됨." }
                ]
            },
            {
                title: "특수한 해류와 현상", desc: "전 지구적 기후 시스템에 막대한 영향을 미치는 독특한 흐름",
                items: [
                    { name: "남극 순환류", examples: ["서풍 피류", "남극 고립", "해양 컨베이어 벨트"], meta: "🌀 지구 최대 해류 · ❄️ 남극 냉각", desc: "다른 대륙의 방해 없이 남극 대륙 주위를 도는 유일한 해류. 남극을 고립시켜 춥게 만듦." },
                    { name: "엘니뇨와 라니냐 (ENSO)", examples: ["동태평양 수온", "무역풍 변화", "전 지구적 기상 이변"], meta: "🔥 엘니뇨 · 💧 라니냐", desc: "수년 주기로 동태평양의 수온이 변하며 전 세계의 가뭄, 홍수 등 기상 이변을 일으키는 현상." },
                    { name: "용승 현상 (Upwelling)", examples: ["페루 연안", "캘리포니아 연안", "영양 염류"], meta: "🐟 황금 어장 · 🌊 심층수 상승", desc: "바람에 의해 표층수가 밀려나고 그 자리를 영양분이 풍부한 심층수가 채우는 현상." }
                ]
            }
        ]
    },
        ...
        subCards: [
            {
                ...
                items: [
                    { name: "북서태평양 어장", examples: ["도호쿠 산리쿠 해역", "오호츠크해 캄차카", "동해 대화퇴", "명태/꽁치"], meta: "🌊 <a href=\"https://www.google.com/search?q=조경수역\" target=\"_blank\"><i class=\"term\">조경수역</i></a> · 🐟 한/난류 교차", desc: "쿠릴 한류와 쿠로시오 난류가 만나 세계 최대의 어획량을 자랑하는, 명태와 오징어의 본산." },
                    { name: "북동대서양 어장", examples: ["도거뱅크(Dogger Bank)", "로포텐 제도", "아이슬란드 어장", "대구/청어"], meta: "🌊 북대서양 난류 · 🐟 피시 앤 칩스", desc: "북대서양 해류가 운반하는 영양분으로 대구와 청어가 풍부한 유럽의 전통적인 수산물 공급 기지." },
                    { name: "남동태평양 어장", examples: ["페루 훔볼트 용승대", "칠레 이키케", "안초비(엔초비)", "어분 공장"], meta: "🌊 <a href=\"https://www.google.com/search?q=용승\" target=\"_blank\"><i class=\"term\">용승 현상</i></a> · 🌽 축산업의 기반", desc: "페루 한류의 강력한 용승으로 플랑크톤이 폭발하여, 전 세계 사료로 쓰이는 멸치가 주로 잡히는 어장." }
                ]
            },
            {
                title: "난류성 어장", desc: "다양한 어종이 서식하는 따뜻한 바다와 갯벌. 다품종 소량 생산.",
                items: [
                    { name: "새우 & 게 (갑각류)", examples: ["루이지애나 멕시코만", "메콩강 하구", "타이만", "블랙타이거"], meta: "🦐 열대 연안 생태계", desc: "영양이 풍부한 열대 연안에서 서식하며, 양식업으로도 중요한 대표 갑각류." },
                    { name: "오징어 & 문어 (두족류)", examples: ["울릉도·독도 해역", "포클랜드 제도", "모리타니 연안", "대왕오징어"], meta: "🦑 글로벌 식재료", desc: "암초나 모래 지대에 서식하며 야간 조업으로 잡는, 세계인의 사랑을 받는 두족류." },
                    { name: "고등어 & 갈치 (회유어)", examples: ["제주도 남방 해역", "노르웨이 연안", "동중국해", "쿠로시오 난류"], meta: "🐟 서민의 밥상", desc: "따뜻한 해류를 따라 이동하며 각국 서민들의 식탁을 책임지는 대중 어종." }
                ]
            },
            {
                title: "원양 어업과 국제적 논쟁", desc: "국경 없는 대양을 누비며 고부가가치 어종을 잡는 첨단 어업과 그 이면의 갈등.",
                items: [
                    { name: "참치: 대양의 유목민", examples: ["중서부 태평양(WCPO)", "인도양 세이셸", "지중해 몰타(축양)", "참다랑어"], meta: "🍣 스시 문화의 핵심 · 🛥️ 국제적 자원 관리", desc: "따뜻한 바다를 회유하는 참치를 쫓아 전 세계 대양을 누비는, 기술과 자본이 집약된 산업." },
                    { name: "크릴·이빨고기: 남극의 자원", examples: ["로스해(Ross Sea)", "사우스조지아섬", "웨델해", "메로(이빨고기)"], meta: "🦐 남극 생태계 기반 · 💊 바이오 자원", desc: "남극 생태계의 근간이자 건강식품 원료로 주목받으며, 엄격한 국제 관리하에 조업이 이루어지는 어장." },
                    { name: "고래 (포경 논쟁)", examples: ["일본 다이지", "남극해 조사 포경", "페로 제도", "IWC"], meta: "🚫 국제적 금지 · 🐳 문화 vs 생태", desc: "식용 문화를 지키려는 국가와 생태 보존을 외치는 국제 사회의 첨예한 대립이 계속되고 있다." },
                    { name: "상어 (샥스핀 문제)", examples: ["홍콩 셩완(건어물 거리)", "갈라파고스 보호구역(밀렵)", "샥스핀"], meta: "🦈 생태계 조절자 · 🍽️ 고급 식문화의 비극", desc: "고급 요리 '샥스핀'을 위한 잔혹한 어업으로, 해양 생태계 최상위 포식자가 멸종 위기에 처했다." }
                ]
            },
            {
                title: "연안 양식", desc: "자연산 어획량의 한계를 극복하고 안정적인 공급을 가능케 한 '바다의 농업 혁명'.",
                items: [
                    { name: "연어: 차가운 협만의 첨단 양식", examples: ["노르웨이 피오르 가두리", "칠레 파타고니아 수로", "스코틀랜드", "대서양 연어"], meta: "🇳🇴 첨단 양식 기술 · 💰 자본 집약적 산업", desc: "피오르 협만의 차가운 물과 자동화 기술이 결합된, 자본 집약적 첨단 양식업의 대표 주자." },
                    { name: "새우: 열대 연안의 대량 양식", examples: ["베트남 까마우(맹그로브)", "에콰도르 과야킬", "태국 수랏타니", "흰다리새우"], meta: "🦐 세계 최대 양식 품목 · 🌳 환경 파괴 논란", desc: "열대 연안의 넓은 갯벌을 활용한 대량 생산 방식. 맹그로브 숲 파괴라는 딜레마를 안고 있다." },
                    { name: "패류 & 해조류: 갯벌의 전통 양식", examples: ["완도·진도(김/전복)", "통영(굴)", "프랑스 캉칼(굴)", "리아스식 해안"], meta: "🌏 세계 유일 김 양식 · 갯벌 생태계 활용", desc: "조수간만의 차가 큰 갯벌과 청정 해역의 특성을 활용한 전통 양식. 김은 한국이 독보적." }
                ]
            }
        ]
    },
    "ocean-5": {
        ...
        subCards: [
            ...
            },
            {
                ...
                items: [
                    { name: "북해 유전 (브렌트유)", examples: ["영국", "노르웨이", "브렌트유", "해상 플랫폼"], meta: "🛢️ 유럽의 에너지원 · ⚓ 국제 유가 기준", desc: "국제 유가의 기준이 되는 브렌트유가 생산되는, 유럽 에너지 자립의 심장." },
                    { name: "멕시코만 유전 (딥워터 호라이즌)", examples: ["미국", "루이지애나", "심해 시추", "허리케인"], meta: "🇺🇸 미국 에너지 허브 · 🌊 심해 시추 기술", desc: "미국 석유 산업의 중심지이자, 심해 시추 기술의 발달과 환경 재앙의 위험이 공존하는 곳." },
                    { name: "브라질 심해 유전 (룰라 필드)", examples: ["프리살(Pre-salt)", "페트로브라스", "해양 플랜트"], meta: "🇧🇷 신흥 산유국 · 🧂 암염층 아래", desc: "두꺼운 암염층 아래에 묻혀 있는 막대한 양의 심해 유전. 브라질을 산유국 반열에 올림." },
                    { name: "클라리온-클리퍼턴 지역 (망간 단괴)", examples: ["태평양 공해", "희귀 금속", "심해 채굴"], meta: "🔋 미래 자원의 보고 · 🌊 생태계 파괴 논란", desc: "태평양 심해저에 깔려 있는, 배터리 핵심 광물이 풍부한 망간 단괴 지대." },
                    { name: "북해 해상풍력 (도거뱅크)", examples: ["영국", "덴마크", "해상 풍력 단지"], meta: "🌬️ 유럽의 녹색 발전소 · ⚡ 대규모 단지", desc: "얕은 수심과 강한 바람을 이용해 거대한 해상 풍력 발전 단지를 건설하는 녹색 에너지의 중심." },
                    { name: "시화호 조력발전소", examples: ["대한민국", "방조제", "조수 간만의 차"], meta: "🇰🇷 세계 최대 조력 · 🌕 달의 에너지", desc: "서해안의 큰 조수 간만의 차를 이용하여 전기를 생산하는 세계 최대 규모의 조력 발전소." }
                ]
            },
            {
        ...
        subCards: [
            {
                ...
                items: [
                    { name: "배타적 단일 민족 국가", examples: ["<i data-flag=\"🇰🇷\">한국</i>", "<i data-flag=\"🇯🇵\">일본</i>", "<i data-flag=\"🇵🇱\">폴란드</i>", "<i data-flag=\"🇭🇺\">헝가리</i>"], meta: "🛡️ 배타적 민족주의 · 🩸 혈통 중시", desc: "외부의 침략에 맞서며 형성된 강력한 민족적 동질감과 문화적 자부심." },
                    { name: "아프리카의 뿔", examples: ["<i data-flag=\"🇪🇹\">에티오피아</i>", "암하라족", "티그라이족", "<i data-flag=\"🇸🇴\">소말리아</i>"], meta: "⚔️ 씨족 갈등 · 🧩 내부 분열", desc: "외부적으로는 단일 민족으로 보이지만, 내부적으로는 지역과 씨족에 따라 분열된 정체성." },
                    { name: "아이슬란드", examples: ["<i data-flag=\"🇮🇸\">아이슬란드</i>", "노르드인", "사가(Saga)"], meta: "🧬 유전적 고립 · 🌊 섬나라 정체성", desc: "거친 바다로 둘러싸인 섬에서 천 년 넘게 보존한 순수한 정체성" }
                ]
            },
            {
